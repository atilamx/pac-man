...
Window.ScreenCanvas = (function Screen(){
  ...
  var initialize = function(extContext){
    ...
    urls = [
      'miscellaneous/global_constants.js',
      'miscellaneous/initialize.js',
      'maze/leftCanvas.js',
      'miscellaneous/interrupts.js',
      'observers/eventsobserver.js',
      'observers/keyobserver.js',
      'maze/scoreobserver.js',
      'storage/base.js',
      'storage/lifes.js',
      'maze/textscore.js',
      'controller/sound_effects.js',
      'engines/engine.js',
      'engines/randomEngine.js',
      'engines/huntEngine.js',
      'engines/squareEngine.js',
      'engines/megamind.js',
      'characters/gameCharacterVelocity.js',
      'characters/gameCharacter.js',
      'maze/maze.js',
      'maze/maze_limits.js',
      'maze/pills.js',
      'maze/labyrinth.js',
      'engines/graph_constructor.js',
      'miscellaneous/loop.js',
      'maze/scoreobserver.js',
      'characters/gameCharacter.js',
      'engines/megamind.js'
    ];
